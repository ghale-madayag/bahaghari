...
<script>
    ...
    $('#etaDateEdit').datepicker({
        autoclose: true
    })

    $('#estDateEdit').datepicker({
        autoclose: true
    })
    $(".checkbox-toggle").click(function () {
      ...
      if (clicks) {
        ...
        $(".records-all input[type='checkbox']").iCheck("uncheck");
        $(".far", this).removeClass("fa-check-square").addClass('fa-square');
      } else {
        //Check all checkboxes
        $(".records-all input[type='checkbox']").iCheck("check");
