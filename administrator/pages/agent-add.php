        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Agent Information Entry</h3>
                </div>
                <form role="form" class="form-horizontal" method="post" id="form-ag-add" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="col-xs-12">
                            <div class="form-group row">
                                <label for="agCode" class="col-sm-4 control-label">Agent Code:</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="agCode" name="agCode" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="cliBdate" name="agBdate">
                                </div>
                            </div>
                            <div class="form-group row">
